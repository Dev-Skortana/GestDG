...
{
    class Initialise_parametres_recherches
    {

        public IEnumerable<Parametre_recherche_sql> get_initialise_parametres_recherches_sql(INavigationParameters parameters,String key)
        {
