...
{
    class Load_donnees_of_viewmodel_fastmembre<type_retour> : Load_donnees_base,Load_donnees<type_retour>
    {
        IService_Membre service_membre;

        public Load_donnees_of_viewmodel_fastmembre(IService_Membre service_membre)
        {
