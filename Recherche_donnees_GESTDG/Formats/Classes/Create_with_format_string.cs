...
namespace Recherche_donnees_GESTDG.Formats.Classes
{
    public class Create_with_format_string : ICreate_with_format
    {
        public string Create_condition(string champ, Object valeur, Enumerations_recherches.methodes_recherches methode_recherche)
        {
            ...
            resultat += methode_recherche == Enumerations_recherches.methodes_recherches.Commence_par ? $" like '{donnees_string}%'" : (methode_recherche == Enumerations_recherches.methodes_recherches.Fini_par ? $" like '%{donnees_string}'" : (methode_recherche == Enumerations_recherches.methodes_recherches.Contient ? $" like '%{donnees_string}%'" : $"=='{donnees_string}'"));
            return resultat;
        }
